...
import com.example.notes.NotesClockListener;
...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder> {
    Context context;
    List<Notes> list;
    NotesClockListener listener;

    public NotesListAdapter(Context context, List<Notes> list, NotesClockListener listener) {
    ...
    public void filterList (List<Notes> filtredList){
        list = filtredList;
