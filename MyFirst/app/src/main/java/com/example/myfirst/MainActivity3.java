...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btsec = findViewById(R.id.buttonSecond);
        btsec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                showInfo(mainText.getText().toString(), btsec);
                showInfoAllert("Вы хотите закрыть приложение?");
            }
        });
    }
    ...
    private void showInfoAllert(String text) {
        ...
        builder.setTitle("Заголовок окна").setMessage(text).setCancelable(false).setPositiveButton("Да", new DialogInterface.OnClickListener() {
            @Override
